...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$body, email, password, user, validPassword, token;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          validPassword = _bcryptjs["default"].compareSync(password, user.password);
          if (validPassword) {
            _context.next = 12;
            break;
          }
        ...
        case 12:
          _context.next = 14;
          return (0, _generateJWT.generateJWT)(user.id);
        case 14:
          token = _context.sent;
          res.json({
            token: token
